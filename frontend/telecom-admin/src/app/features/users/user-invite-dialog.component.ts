...
import { UserInvite } from './user.models';
...
@Component({
  ...
  template: `
    ...
    <mat-dialog-content>
      <p class="hint">
        We'll create the account in a pending state and send an invite to set
        their password.
      </p>
      <div class="form">
...
export class UserInviteDialogComponent {
  ...
  private readonly ref = inject(MatDialogRef<UserInviteDialogComponent>);

  readonly form = this.fb.nonNullable.group({
    email: ['', [Validators.required, Validators.email]],
    first_name: [''],
    last_name: [''],
    role: ['company_user' as const, [Validators.required]],
  });
